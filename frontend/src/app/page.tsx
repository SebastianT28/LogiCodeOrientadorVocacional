...
export default function Page() {
  ...
  return (
    <>
      ...
      <header
        id="main-header"
        className={`fixed top-0 left-0 w-full z-50 transition-all duration-300 ${isScrolled ? "bg-white shadow-md text-gray-800" : "bg-transparent text-white"
          }`}
      >
        <div className="max-w-7xl mx-auto px-6 lg:px-8 h-20 flex items-center justify-between">
          ...
          <a href="#inicio" className="flex items-center gap-3 group">
            <img
              ...
              id="logo-img"
              alt="Logo UTP"
              className={`h-10 w-auto object-contain transition-all duration-300 ${isScrolled ? "imagen-negativa" : ""
                }`}
            />
          </a>
        ...
        <div
          id="mobile-menu"
          className={`md:hidden absolute top-20 left-0 w-full bg-charcoal border-t border-white/10 shadow-xl py-6 px-6 flex flex-col space-y-4 transition-all duration-300 transform ${isMenuOpen ? "opacity-100 translate-y-0" : "opacity-0 -translate-y-4 pointer-events-none"
            }`}
        >
          ...
          <a href="/test-vocacional" onClick={toggleMenu} className="mobile-link text-center bg-utpRed hover:bg-utpDarkRed text-white py-3 rounded-full text-sm font-semibold uppercase tracking-wider transition-all shadow-md">
            Comenzar Test →
          </a>
        </div>
      </header>
        ...
        <div className="w-full md:w-1/2 bg-utpRed flex flex-col justify-center px-8 py-20 md:px-16 lg:px-24 text-white relative z-10">
          <div className="max-w-xl">
            ...
            <div className="flex flex-col sm:flex-row gap-4">
              <a href="/test-vocacional" className="inline-flex items-center justify-center bg-utpRed hover:bg-white hover:text-utpRed text-white border border-white font-semibold px-8 py-3.5 rounded-full transition-all duration-300 shadow-lg group">
                Comenzar ahora
